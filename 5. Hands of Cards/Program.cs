	...
	class Program
	{
		static void Main()
		{
			...
			while (input != "JOKER")
			{
				...
				var cardArgs = commandArgs[1].Trim().Split(new[] { "," }, StringSplitOptions.RemoveEmptyEntries);
		...
		private static void AddCardsToPerson( Dictionary<string,int>person,  string[] cardArgs)
		{
